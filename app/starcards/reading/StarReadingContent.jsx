...
// NOT WITH TOTAL RANDOMNESS BASED ON WEIGHTS
// "use client";
...
//         setReadingTrigger((prev) => prev + 1);
//         setApiError(null);
//     }, [name, birthDate, starSign, spreadId, cardCount, calculateInfluences, isLoading]);
...
//                     <Button text="Reset" onClick={resetSpread} disabled={stableDrawnCards.length === 0} />
//                     <Link href="/readingchoice">
//                         <Button text="Choose Another Spread" onClick={() => { }} disabled={false} />
//                     </Link>
//                 </div>
//                 {stableDrawnCards.length > 0 && (
//                     <AIStarReading
